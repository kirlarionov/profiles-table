   ...
   return (
      <ThemeProvider theme={theme === 'light' ? lightTheme : darkTheme}>
         <AppWrapper>
            <Router>
               <TopHeader>
                  <ThemeButton onClick={() => toggleTheme(theme, setTheme)}><Trans i18nKey={"Toggle Theme"} /></ThemeButton>
                  <GlobalStyles />
               ...
               <Switch>
                  ...
                  <Route path="/profile-summary/:userId" component={ProfileSummary} />
                  <Route exact path="/profile-summary" component={NotFound} />
               </Switch>
            </Router>
            <Slider />
         </AppWrapper>
